...
interface IAccountDeployContract {
    // function createCW3endowment(Cw3EndowmentMessages.EndowmentInstantiateMsg memory cw3createendowmentmessage) external returns(address CW3EndowmentAddress);
