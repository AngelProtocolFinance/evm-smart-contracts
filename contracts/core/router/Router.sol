...
contract Router is IRouter, OwnableUpgradeable, AxelarExecutable {
  ...
  function _redeem(
    ...
    emit TokenRedeemed(_action, _redeemedAmt);
    if (
  ...
  function _prepareAndSendTokensLocal(
    ...
    emit TokenSent(_action, _sendAmt);
    return _action;
  }
