...
interface IEndowmentMultiSigEmitter {
  function transactionConfirmedEndowment(uint256 endowmentId, address owner, uint256 transactionId) external;

  function transactionConfirmationRevokedEndowment(uint256 endowmentId, address owner, uint256 transactionId) external;

  function transactionConfirmationOfFormerOwnerRevokedEndowment(uint256 endowmentId, address formerOwner, uint256 transactionId) external;

  function transactionSubmittedEndowment(uint256 endowmentId, address owner, uint256 transactionId) external;
  ...
  function ownerReplacedEndowment(uint256 endowmentId, address currOwner, address newOwner) external;
