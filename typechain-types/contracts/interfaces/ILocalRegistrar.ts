...
export declare namespace ILocalRegistrar {
  ...
  export type StrategyParamsStruct = {
    ...
    Locked: ILocalRegistrar.VaultParamsStruct;
    Liquid: ILocalRegistrar.VaultParamsStruct;
  };

  export type StrategyParamsStructOutput = [
    number,
    ILocalRegistrar.VaultParamsStructOutput,
    ILocalRegistrar.VaultParamsStructOutput
  ] & {
    approvalState: number;
    Locked: ILocalRegistrar.VaultParamsStructOutput;
    Liquid: ILocalRegistrar.VaultParamsStructOutput;
  };
}
...
export interface ILocalRegistrarInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [ILocalRegistrar.AngelProtocolParamsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [ILocalRegistrar.RebalanceParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface AngelProtocolParamsChangedEventObject {
  newAngelProtocolParams: ILocalRegistrar.AngelProtocolParamsStructOutput;
}
export type AngelProtocolParamsChangedEvent = TypedEvent<
  [ILocalRegistrar.AngelProtocolParamsStructOutput],
...
export interface RebalanceParamsChangedEventObject {
  newRebalanceParams: ILocalRegistrar.RebalanceParamsStructOutput;
}
export type RebalanceParamsChangedEvent = TypedEvent<
  [ILocalRegistrar.RebalanceParamsStructOutput],
...
export interface ILocalRegistrar extends BaseContract {
  ...
  functions: {
    ...
    getAngelProtocolParams(
      overrides?: CallOverrides
    ): Promise<[ILocalRegistrar.AngelProtocolParamsStructOutput]>;
    ...
    getRebalanceParams(
      overrides?: CallOverrides
    ): Promise<[ILocalRegistrar.RebalanceParamsStructOutput]>;
    ...
    getStrategyParamsById(
      _strategyId: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<[ILocalRegistrar.StrategyParamsStructOutput]>;
    ...
    setAngelProtocolParams(
      _angelProtocolParams: ILocalRegistrar.AngelProtocolParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setRebalanceParams(
      _rebalanceParams: ILocalRegistrar.RebalanceParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
