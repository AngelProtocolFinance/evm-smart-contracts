...
export interface AccountsStrategiesUpdateEndowmentsInterface
  extends utils.Interface {
  functions: {
    "updateStrategies(uint256,uint8,(string,uint256)[])": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "updateStrategies"): FunctionFragment;
...
export interface AccountsStrategiesUpdateEndowments extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountsStrategiesUpdateEndowmentsInterface;
  ...
  functions: {
    updateStrategies(
      ...
      curStrategies: AccountMessages.StrategyStruct[],
