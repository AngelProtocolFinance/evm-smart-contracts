...
export interface AccountsAllowanceInterface extends utils.Interface {
  functions: {
    "manageAllowances(uint256,string,address,(uint256,uint256,bool,uint256,bool),address)": FunctionFragment;
    "spendAllowance(uint256,address,uint256,address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [
      ...
      PromiseOrValue<string>,
      AccountStorage.AllowanceDataStruct,
      PromiseOrValue<string>
    ]
  ): string;
  encodeFunctionData(
...
export interface AccountsAllowance extends BaseContract {
  ...
  functions: {
    manageAllowances(
      ...
      curAllowance: AccountStorage.AllowanceDataStruct,
