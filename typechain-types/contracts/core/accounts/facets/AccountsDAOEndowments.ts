...
export interface AccountsDAOEndowmentsInterface extends utils.Interface {
  functions: {
    "setupDao(uint256,(uint256,uint256,uint256,uint256,uint256,uint128,uint256,(uint8,(address,uint256,string,string,(uint8,(uint128,uint256,uint128,uint128)),string,string,uint256,address,uint256,uint256))))": FunctionFragment;
  };
...
export interface AccountsDAOEndowments extends BaseContract {
  ...
  functions: {
    setupDao(
      ...
      curDetails: AngelCoreStruct.DaoSetupStruct,
