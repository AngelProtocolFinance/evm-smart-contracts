...
export interface AccountsUpdateInterface extends utils.Interface {
  ...
  getFunction(nameOrSignatureOrTopic: "updateConfig" | "updateOwner"): FunctionFragment;

  encodeFunctionData(
    functionFragment: "updateConfig",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>, AngelCoreStruct.FeeSettingStruct]
  ): string;
