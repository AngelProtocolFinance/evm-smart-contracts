...
export interface AccountsStrategiesCopyEndowmentsInterface
...
export interface AccountsStrategiesCopyEndowments extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountsStrategiesCopyEndowmentsInterface;
  ...
  functions: {
    copycatStrategies(
      curCopytoid: PromiseOrValue<BigNumberish>,
      curAccountType: PromiseOrValue<BigNumberish>,
      curCopyfromid: PromiseOrValue<BigNumberish>,
