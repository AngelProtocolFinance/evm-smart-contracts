...
export interface AccountDonationMatchInterface extends utils.Interface {
  functions: {
    "depositDonationMatchErC20(uint256,address,uint256)": FunctionFragment;
    "setupDonationMatch(uint256,(uint8,(address,address,uint24)))": FunctionFragment;
    "withdrawDonationMatchErC20(uint256,address,uint256)": FunctionFragment;
  };
...
export interface AccountDonationMatch extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountDonationMatchInterface;
  ...
  functions: {
    ...
    setupDonationMatch(
      curId: PromiseOrValue<BigNumberish>,
      curDetails: AccountMessages.DonationMatchStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
