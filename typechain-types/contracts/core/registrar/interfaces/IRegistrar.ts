...
export interface IRegistrarInterface extends utils.Interface {
  functions: {
    ...
    "updateFee((uint8,address,uint256))": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "queryFee", values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "vaultRemove", values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
...
>>>>>>> master
  ...
  decodeFunctionResult(functionFragment: "vaultRemove", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "vaultUpdate", data: BytesLike): Result;
...
export interface IRegistrar extends BaseContract {
  ...
  queryFee(name: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    updateOwner(newOwner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    vaultRemove(_stratagyName: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
