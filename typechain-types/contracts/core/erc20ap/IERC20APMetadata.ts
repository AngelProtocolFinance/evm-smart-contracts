...
export interface IERC20APMetadataInterface extends utils.Interface {
  functions: {
    "allowance(uint32,uint32)": FunctionFragment;
    "approve(uint32,uint256)": FunctionFragment;
  ...
  events: {
    "Approval(uint32,uint32,uint256)": EventFragment;
...
export interface IERC20APMetadata extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC20APMetadataInterface;
  ...
  functions: {
    allowance(
      ...
      spender: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    "Approval(uint32,uint32,uint256)"(
      owner?: PromiseOrValue<BigNumberish> | null,
      spender?: PromiseOrValue<BigNumberish> | null,
      value?: null
    ): ApprovalEventFilter;
    Approval(
      owner?: PromiseOrValue<BigNumberish> | null,
