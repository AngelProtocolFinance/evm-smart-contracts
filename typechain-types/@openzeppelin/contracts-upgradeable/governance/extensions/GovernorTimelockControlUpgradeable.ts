...
export interface GovernorTimelockControlUpgradeableInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "updateTimelock", values: [PromiseOrValue<string>]): string;
...
export interface GovernorTimelockControlUpgradeable extends BaseContract {
  ...
  callStatic: {
    ...
    updateTimelock(newTimelock: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
