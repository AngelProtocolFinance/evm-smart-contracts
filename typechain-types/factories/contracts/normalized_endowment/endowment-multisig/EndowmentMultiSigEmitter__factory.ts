...
export class EndowmentMultiSigEmitter__factory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): EndowmentMultiSigEmitter {
    return new Contract(address, _abi, signerOrProvider) as EndowmentMultiSigEmitter;
  }
}
