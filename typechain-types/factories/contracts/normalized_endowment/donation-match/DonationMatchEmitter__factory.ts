...
export class DonationMatchEmitter__factory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): DonationMatchEmitter {
    return new Contract(address, _abi, signerOrProvider) as DonationMatchEmitter;
  }
}
