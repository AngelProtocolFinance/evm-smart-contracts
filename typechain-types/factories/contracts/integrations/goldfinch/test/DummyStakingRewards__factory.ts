...
export class DummyStakingRewards__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(_rewardToken, _stakeToken, overrides || {}) as Promise<DummyStakingRewards>;
  }
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(_rewardToken, _stakeToken, overrides || {});
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): DummyStakingRewards {
