...
import type {
  HaloToken,
  HaloTokenInterface,
} from "../../../../contracts/mock/haloToken.sol/HaloToken";
...
const isSuperArgs = (
  xs: HaloTokenConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class HaloToken__factory extends ContractFactory {
  constructor(...args: HaloTokenConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    return super.deploy(supply, overrides || {}) as Promise<HaloToken>;
  }
  ...
  override attach(address: string): HaloToken {
    return super.attach(address) as HaloToken;
  }
  override connect(signer: Signer): HaloToken__factory {
    return super.connect(signer) as HaloToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): HaloTokenInterface {
    return new utils.Interface(_abi) as HaloTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HaloToken {
    return new Contract(address, _abi, signerOrProvider) as HaloToken;
  }
}
