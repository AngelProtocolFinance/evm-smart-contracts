...
import type {Community, CommunityInterface} from "../../../../contracts/halo/community/Community";
...
type CommunityConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
...
export class Community__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & {from?: PromiseOrValue<string>}): Promise<Community> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): Community {
