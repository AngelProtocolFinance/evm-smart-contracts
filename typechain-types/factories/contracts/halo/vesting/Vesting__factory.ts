...
import type {Vesting, VestingInterface} from "../../../../contracts/halo/vesting/Vesting";
...
export class Vesting__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & {from?: PromiseOrValue<string>}): Promise<Vesting> {
