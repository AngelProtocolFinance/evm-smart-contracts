...
import type {Airdrop, AirdropInterface} from "../../../../contracts/halo/airdrop/Airdrop";
...
export class Airdrop__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & {from?: PromiseOrValue<string>}): Promise<Airdrop> {
