...
import type {GovHodler, GovHodlerInterface} from "../../../../contracts/halo/gov-hodler/GovHodler";
...
type GovHodlerConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
...
export class GovHodler__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & {from?: PromiseOrValue<string>}): Promise<GovHodler> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GovHodler {
