...
import type {DummyGateway, DummyGatewayInterface} from "../../../contracts/test/DummyGateway";
...
export class DummyGateway__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & {from?: PromiseOrValue<string>}): Promise<DummyGateway> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): DummyGateway {
