...
import type {DummyERC20, DummyERC20Interface} from "../../../contracts/test/DummyERC20";
...
export class DummyERC20__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & {from?: PromiseOrValue<string>}): Promise<DummyERC20> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): DummyERC20 {
