...
describe("AP Team Interaction with Index Fund", function () {
  ...
  it("Should be able to add and remove alliance members", async function () {
    ...
    let data = indexFund.interface.encodeFunctionData("updateAllianceMemberList", [
      allianceMember1.address,
      "add",
    ]);
    ...
    data = indexFund.interface.encodeFunctionData("updateAllianceMemberList", [
      allianceMember2.address,
      "add",
    ]);
    ...
    expect(allianceMembers).to.deep.equal([
      allianceMember2.address,
      ADDRESS_ZERO,
      ADDRESS_ZERO,
      ADDRESS_ZERO,
  ...
  it("Should update registrar in index fund", async function () {
    ...
    const data = indexFund.interface.encodeFunctionData("updateRegistrar", [
