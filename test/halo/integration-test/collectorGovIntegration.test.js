...
describe("Collector Gov Integration", function () {
    ...
    it("should update config", async function() {      
        let tx, receipt;
        const data = collector.interface.encodeFunctionData("updateConfig", [80, timeLockAddress, govAddress, swapping.address]);
        ...
        const proposalId = receipt.events.filter(e => e.event === "ProposalCreated")[0].args.proposalId;
